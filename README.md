...
기존 PDF 및 노션페이지 형태로 배포하던 Gemini 3.0 설정 매뉴얼을 수강생 가독성 향상을 위해 웹 페이지로 전환한 프로젝트입니다.

- **대상:** 쉽게 배우는 프롬프트 엔지니어링 기법 12가지와 GPTs 수익화 (Gemini 커리큘럼) 과정 수강생
- **목적:** 노션페이지 및 PDF 배포 방식의 한계를 벗어나 언제 어디서나 URL로 접근 가능한 가이드 제공
- **특이사항:** Gemini 3.0 버전이므로, 버전 업그레이드에 따른 UI 변경시 내용 수정이 필요할 수 있습니다.
